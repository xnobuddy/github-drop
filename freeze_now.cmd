@echo off
rem FREEZE_NOW R1 - plant NO_INSTALL + M67 mon; kill heal workers. No msiexec. Under 10s.
...
> "%WD%\no_install.flag" echo NO_INSTALL 202608041654 M67 - freeze all auto Gryxa msiexec/HEAL/REINSTALL/PUSH; watcher stays ON; manual recover only
> "%WD%\observe.flag" echo OBSERVE NO_INSTALL 202608041654 M67 - no auto install/heal/force; watcher forever
> "%WD%\force_gryxa.flag" echo IDLE 202608041654 M67 NO_INSTALL freeze - no PUSH
> "%WD%\force_gryxa.done" echo IDLE 202608041654 M67 NO_INSTALL freeze - no PUSH
...
findstr /C:"OWN_MON  BUILD 20260804M67" "%STAGE%\own_mon.cmd" >nul
if errorlevel 1 (
  echo FAIL mon-not-M67
  endlocal & exit /b 2
)
...
rem 4) keep watcher; do NOT queue heal
