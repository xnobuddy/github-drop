@echo off
rem FORCE_MON_UPDATE R2 - overwrite mon/lib/secure/tg/channel from pin; kick mon. No msiexec.
setlocal
...
findstr /C:"MONVER=M7" "%STAGE%\own_mon.cmd" >nul
if errorlevel 1 (
  echo FAIL mon-not-M7x
  endlocal & exit /b 2
)
